param(
    ...
    [string]$Message = "Ваш пароль доменной учетной записи истекает через {0} дней`n`nДля смены пароля нажмите кнопку «Сменить пароль» (вставка нового пароля из KeePass/Passbolt)`nили используйте Ctrl + Alt + End → Изменить пароль",
